...
//    private int progress_color = 0xEEF9CD15;            //进度条颜色
    private int outside_color = 0xEEDCDCDC;             //外圆背景色
//    private int outside_color = 0x55F9CD15;             //外圆背景色
    private int inside_color = 0xFFFFFFFF;              //内圆背景色
//    private int inside_color = 0xFFF9CD15;              //内圆背景色
    ...
    public CaptureButton(Context context, int size) {
        ...
        button_state = CameraXView.BUTTON_STATE_BOTH;  //初始化按钮为可录制可拍照
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                //判断按钮状态是否为可录制状态
                if ((button_state == CameraXView.BUTTON_STATE_ONLY_RECORDER || button_state == CameraXView.BUTTON_STATE_BOTH)){
            ...
            case MotionEvent.ACTION_MOVE:
                if (captureLisenter != null
                        ...
                        && (button_state == CameraXView.BUTTON_STATE_ONLY_RECORDER || button_state == CameraXView.BUTTON_STATE_BOTH)) {
    ...
    private void handlerUnpressByState() {
        ...
        switch (state) {
            //当前是点击按下
            case STATE_PRESS:
                if (captureLisenter != null && (button_state == CameraXView.BUTTON_STATE_ONLY_CAPTURE || button_state ==
                        CameraXView.BUTTON_STATE_BOTH)) {
